...
public class LittleSearchEngine {
	...
	public String getKeyword(String word) {
		...
		while (true) {
			int w = word.length() - 1;
			if (word.charAt(w) == '.' || word.charAt(w) == ',' || word.charAt(w) == '?' || word.charAt(w) == ':'
					|| word.charAt(w) == ';' || word.charAt(w) == '!') {
				if (w != 0)
		...
		boolean checkNoise = noiseWords.contains(word);
		if (checkNoise)
			return null;
	...
	public ArrayList<String> top5search(String kw1, String kw2) {
		...
		ArrayList<String> top5 = new ArrayList<String>();
	       ...
	       if (KW2 != null && kw2List != null && kw1List == null){ 
	           ...
	           while ((kw1List.isEmpty() == false || kw2List.isEmpty() == false) && (top5.size() < 5 || 
	        		   top5.size() != 5)) {
	               ...
	               System.out.println("doc added: " + word2.document);
	                   ...
	                   {
	                       if (kw1List.get(i).document.equals(word2.document))
	                       { // if document names match
	                   ...
	                   int i = 0;
	                   while (i < kw1List.size()) {
	                       if (kw1List.get(i).document.equals(word1.document)) { 
	                    	   // if document names match
	                   ...
	                   i = 0;
	                   while (i < kw2List.size()) {
	                       if (kw2List.get(i).document.equals(word1.document)) { 
	                    	   // if document names match
	            	   ...
	            	   // word1 and word2 have the same frequency
	                   System.out.println("c1 == c2");
	                   if (!(word1.document.equals(word2.document))) { 
	                	   // if both words have different doc names
