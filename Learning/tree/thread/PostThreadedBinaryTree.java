...
public class PostThreadedBinaryTree { // 后序线索二叉树
	...
	public static void main(String[] args) {
		...
		System.out.println("线索二叉树为：" + Arrays.toString(array));
	...
	public static class Node {
		...
		boolean isLeftThreaded = false; // 左指针域类型 false：指向子节点、true：前驱或后继线索
		boolean isRightThreaded = false; // 右指针域类型 false：指向子节点、true：前驱或后继线索
	 ...
	 * @param node 节点
	 */
	public void postThreadOrder(Node node) {
		if (node == null) {
			return;
		}
	 ...
	 * @param node
	 */
	public void postThreadList(Node root) {
		// 1、找后序遍历方式开始的节点
		Node node = root;
